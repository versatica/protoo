...
var C = {
	CLOSE_CODES: {
		...
		ONLINE_ELSEWHERE: {code: 3000, reason: 'onine elsewhere'}
	}
};
...
PeerManager.prototype.addPeer = function(username, uuid, data, onPeer, transport) {
	var self = this;
	...
	if (onPeer && typeof onPeer !== 'function') {
		throw new Error('protoo.PeerManager.addPeer() | onPeer must be a function');
	}
